    ...
    <AnimatePresence>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        ...
        >
          ...
          <MoonIcon className="[@media_not_(prefers-color-scheme:dark)]:stroke-primary hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-teal-400/10" />
        </button>
      </motion.div>
    </AnimatePresence>
  );
